...
cat=createSprite(55,400,20,20);
cat.addAnimation("running",cat_running)
cat.addAnimation("collided",cat_collided)
cat.scale=0.5
  
ground=createSprite(100,400,          00,0); ground.addImage(ground_image)
ground.scale=3;
ground.velocityX=-4
...
if(frameCount % 80 ===0) {
 ...
 coins.y=Math.round(random(300,301))
...
function Obstacle(){
if(frameCount%60===0){
   var obstacles = createSprite(300,301,10,40); 
